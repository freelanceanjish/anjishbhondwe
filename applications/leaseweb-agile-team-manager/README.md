...
**Rule:** All new Anjish Bhondwe CVs and cover letters are uploaded here:

`applications/leaseweb-agile-team-manager/`
...
| `anjish-bhondwe-cover-letter-project-manager-software.pdf` | ZeroHassle – Interactivated Solutions Group — Project Manager (remote) · NL move for wife’s PhD · immediate joiner |
